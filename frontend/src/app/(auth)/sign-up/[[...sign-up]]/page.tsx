    ...
    <div className="min-h-screen bg-[#050505] flex items-center justify-center p-4 relative overflow-hidden font-sans">
      ...
      <div className="max-w-md relative z-10">
        <div className="text-center mb-10">
          ...
          <p className="text-white/30 mt-3 text-[10px] font-bold uppercase tracking-[0.2em]">System Initialization</p>
        </div>
        ...
        <p className="text-center text-[10px] font-bold uppercase tracking-widest text-white/40 mt-8">
          Already have an account? <a href="/sign-in" className="text-zinc-400 hover:text-black hover:bg-white px-1 transition-colors no-underline font-bold">Sign in</a>
        </p>
      </div>
    </div>
  )
